...
if use_context:
    ...
    with c1:
        st.markdown(
            ...
            f"<div class='metric-label'>Context injected into AI</div>"
            f"<div style='font-size:0.8rem;color:#66ffbb;margin-top:4px'>"
            + "<br>".join(ctx_parts) +
            f"</div></div>",
    ...
    with c2:
        st.markdown(
            ...
            "<div class='metric-label'>About Ask TEC AI</div>"
            "<div style='font-size:0.8rem;color:#6888aa;margin-top:4px'>"
...
if not messages:
    st.markdown(
        ...
        "<div style='font-size:0.85rem;color:#8899bb;margin-top:4px'>"
